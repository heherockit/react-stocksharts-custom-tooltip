...
class MyHoverTooltip extends Component {
	constructor(props) {
		super(props);
...
MyHoverTooltip.contextTypes = {
	margin: PropTypes.object.isRequired,
	ratio: PropTypes.number.isRequired,
};

MyHoverTooltip.defaultProps = {
	// bgwidth: 150,
	// bgheight: 50,
...
function backgroundShapeSVG({ fill, stroke, opacity }, { height, width }) {
	return <rect className="tooltip-bg"
		height={height}
		width={width}
		fill={fill}
		opacity={opacity}
