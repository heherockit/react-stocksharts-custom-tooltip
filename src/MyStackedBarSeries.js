...
import { identity, hexToRGBA, head, functor, plotDataLengthBarWidth } from "react-stockcharts/lib/utils";

class MyStackedBarSeries extends Component {
	constructor(props) {
		super(props);
...
MyStackedBarSeries.defaultProps = {
...
export default MyStackedBarSeries;